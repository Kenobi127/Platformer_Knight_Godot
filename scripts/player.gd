...
var standing_cshape = preload("res://resources/knight_standing_capsule_cshape.tres")
var crouching_cshape = preload("res://resources/knight_crouching_capsule_cshape.tres")
...
func switch_direction(horizontal_direction): 
	...
	sprite.position.x = horizontal_direction * 4 #4 is the offset of the sprite from center
